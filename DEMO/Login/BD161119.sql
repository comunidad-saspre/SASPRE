...
-- Volcando datos para la tabla saspre.cultivos: ~6 rows (aproximadamente)
...
REPLACE INTO `cultivos` (`IDcultivo`, `Usuario_Cultivo`, `Cultivo`, `Fecha_Plantado`, `Fecha_Cosecha`, `Cantidad`, `Estado`) VALUES
	...
	(29, 'Emiliano', 'Maíz', '2019-11-12', '2020-01-22', 20, 'Sin estado'),
...
-- Volcando datos para la tabla saspre.datosatmosfericosdiarios: ~12 rows (aproximadamente)
