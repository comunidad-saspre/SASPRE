...
-- Volcando estructura para procedimiento saspre.AgregarFertilizaciones
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `AgregarFertilizaciones`(
	IN `_cultivo` VARCHAR(40),
	IN `_necesitaNPK` VARCHAR(20),
	IN `_tieneNPK` VARCHAR(20),
	IN `_diaCalculado` DATE

)
INSERT INTO fertilizaciones(cultivo, necesitaNPK, tieneNPK, diaCalculado)
VALUES(_cultivo, _necesitaNPK, _tieneNPK, _diaCalculado)//
DELIMITER ;
...
REPLACE INTO `cultivos` (`IDcultivo`, `Usuario_Cultivo`, `Cultivo`, `Fecha_Plantado`, `Fecha_Cosecha`, `Cantidad`, `Estado`) VALUES
	...
	(29, 'Emiliano', 'Maíz', '2019-11-12', '2020-01-22', 20, 'Probabilidad de Gusano elotero'),
	(30, 'Emiliano', 'Caña', '2019-11-16', '2019-12-25', 50, 'Probabilidad de Pulgon amarillo'),
	(31, 'Emiliano', 'Maíz', '2019-12-03', '2019-12-03', 50, 'Probabilidad de Trips, Gusano elotero');
...
-- Volcando datos para la tabla saspre.datosclimames: ~4,238 rows (aproximadamente)
...
REPLACE INTO `datosclimames` (`Estacion`, `Fecha_Local`, `Fecha_UTC`, `Direccion_del_Viento`, `Direccion_de_Rafaga`, `Rapidez_de_Viento`, `Rapidez_de_Rafaga`, `Temperatura`, `Humedad_Relativa`, `Presion_Atmosferica`, `Precipitacion`, `Radiacion_Solar`) VALUES
	...
	('CIUDADMANTE', '2019-12-07', '2019-12-08', 153, 176, 7.5, 13.7, 21.4, 71, 1012.5, 0, 0),
	('CIUDADMANTE', '2019-12-07', '2019-12-08', 150, 161, 9, 18.4, 22, 66, 1013, 0, 0),
	('CIUDADMANTE', '2019-12-07', '2019-12-08', 122, 120, 9.8, 19.4, 22.5, 64, 1013, 0, 0),
	('CIUDADMANTE', '2019-12-07', '2019-12-08', 130, 117, 6.1, 18.4, 23, 65, 1012.8, 0, 0),
	('CIUDADMANTE', '2019-12-07', '2019-12-08', 97, 95, 10.8, 22.3, 24.9, 58, 1012, 0, 0),
	('CIUDADMANTE', '2019-12-07', '2019-12-08', 99, 126, 1.6, 5.4, 25.1, 61, 1010.8, 0, 0),
	('CIUDADMANTE', '2019-12-07', '2019-12-07', 118, 34, 4.2, 8.3, 27.4, 53, 1010.3, 0, 56),
	('CIUDADMANTE', '2019-12-07', '2019-12-07', 73, 33, 5, 13, 28.1, 51, 1010.1, 0, 271),
	('CIUDADMANTE', '2019-12-07', '2019-12-07', 200, 353, 4.4, 10.8, 28.2, 50, 1010.4, 0, 426),
	('CIUDADMANTE', '2019-12-07', '2019-12-07', 222, 344, 2.1, 10.8, 28.5, 47, 1011.4, 0, 481),
	('CIUDADMANTE', '2019-12-07', '2019-12-07', 297, 275, 5.7, 18, 27.9, 54, 1012.5, 0, 451),
	('CIUDADMANTE', '2019-12-07', '2019-12-07', 267, 340, 4.8, 16.2, 27.5, 56, 1013.9, 0, 605),
	('CIUDADMANTE', '2019-12-07', '2019-12-07', 300, 271, 6.1, 17.3, 25, 64, 1014.9, 0, 307),
	('CIUDADMANTE', '2019-12-07', '2019-12-07', 282, 247, 4, 11.5, 26.6, 60, 1015.3, 0, 578),
	('CIUDADMANTE', '2019-12-07', '2019-12-07', 304, 337, 3.7, 7.9, 23.5, 70, 1015.2, 0, 136),
	('CIUDADMANTE', '2019-12-07', '2019-12-07', 265, 275, 2.5, 10.1, 21.5, 83, 1014.6, 0, 126),
	('CIUDADMANTE', '2019-12-07', '2019-12-07', 275, 250, 2.1, 4.7, 20, 89, 1014.2, 0, 1),
	('CIUDADMANTE', '2019-12-07', '2019-12-07', 284, 258, 2.2, 5.8, 19.5, 92, 1013.7, 0, 0),
	('CIUDADMANTE', '2019-12-07', '2019-12-07',
 0, 0),
	('CIUDADMANTE', '2019-12-08', '2019-12-08', 155, 165, 6.5, 12.6, 20.7, 78, 1011.2, 0, 0),
	('CIUDADMANTE', '2019-12-08', '2019-12-08', 145, 146, 4.8, 10.4, 20.6, 78, 1011.9, 0, 0);
...
-- Volcando estructura para tabla saspre.fertilizaciones
CREATE TABLE IF NOT EXISTS `fertilizaciones` (
  `idFertilizacion` int(11) NOT NULL AUTO_INCREMENT,
  `cultivo` varchar(40) DEFAULT NULL,
  `necesitaNPK` varchar(20) DEFAULT NULL,
  `tieneNPK` varchar(20) DEFAULT NULL,
  `diaCalculado` date DEFAULT NULL,
  PRIMARY KEY (`idFertilizacion`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla saspre.fertilizaciones: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `fertilizaciones` DISABLE KEYS */;
REPLACE INTO `fertilizaciones` (`idFertilizacion`, `cultivo`, `necesitaNPK`, `tieneNPK`, `diaCalculado`) VALUES
	(3, 'Maíz', '58,37,106', '10,5,7', '2019-12-09');
...
-- Volcando datos para la tabla saspre.graficos: ~6 rows (aproximadamente)
...
REPLACE INTO `graficos` (`idGraficos`, `Identificador`, `Latitud`, `Longitud`, `Color`, `NombreDelTerreno`, `Usuario`, `Cultivo`, `FechaPlantado`, `FechaCosecha`, `Cantidad`, `Estado`) VALUES
	...
	(29, 2, '22.7025386194178', '-99.0116912126541', 'Color [A=50, R=255, G=255, B=0]', 'Maíz', 'Admin', 'Maíz', 'domingo, 8 de diciembre de 2019', 'domingo, 8 de diciembre de 2019', 7, NULL),
	(30, 2, '22.7023456165407', '-99.0109723806381', 'Color [A=50, R=255, G=255, B=0]', 'Maíz', 'Admin', 'Maíz', 'domingo, 8 de diciembre de 2019', 'domingo, 8 de diciembre de 2019', 7, NULL),
	(31, 2, '22.7027514171464', '-99.0108650922775', 'Color [A=50, R=255, G=255, B=0]', 'Maíz', 'Admin', 'Maíz', 'domingo, 8 de diciembre de 2019', 'domingo, 8 de diciembre de 2019', 7, NULL),
	(32, 2, '22.7028652390516', '-99.0112566947937', 'Color [A=50, R=255, G=255, B=0]', 'Maíz', 'Admin', 'Maíz', 'domingo, 8 de diciembre de 2019', 'domingo, 8 de diciembre de 2019', 7, NULL);
...
-- Volcando estructura para procedimiento saspre.MostrarFertilizaciones
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `MostrarFertilizaciones`(
)
...
-- Volcando datos para la tabla saspre.reportesalarmas: ~1 rows (aproximadamente)
...
REPLACE INTO `reportesalarmas` (`IDreporte`, `nombreAlarma`, `temperaturaMaxima`, `temperaturaMinima`, `fechaInicio`, `fechaFin`, `fechaActivada`, `alarmaActivada`) VALUES
	...
	(2, 'Alarma1', 26, 20, '04/12/2019 12:00:00 a. m.', '28/11/2019 12:00:00 a. m.', '08/12/19', 'Sobrepaso la temperatura maxima'),
	(3, 'Alarma1', 26, 20, '08/12/2019 12:00:00 a. m.', '04/12/2019 12:00:00 a. m.', '09/12/19', 'Sobrepaso la temperatura maxima');
