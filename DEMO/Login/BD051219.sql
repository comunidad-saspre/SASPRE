...
-- Volcando datos para la tabla saspre.alarmascultivos: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla saspre.bitacoraalmacen: ~5 rows (aproximadamente)
...
-- Volcando datos para la tabla saspre.cultivos: ~7 rows (aproximadamente)
...
-- Volcando datos para la tabla saspre.datosatmosfericosdiarios: ~21 rows (aproximadamente)
...
-- Volcando datos para la tabla saspre.datosclimames: ~4,848 rows (aproximadamente)
