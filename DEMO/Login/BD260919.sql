...
-- Volcando datos para la tabla saspre.almacen: ~0 rows (aproximadamente)
...
begin
    insert into almacen(tipoObjeto, nombreObjeto, cantidadObjeto, tipoSiembra, precio, fechaIngreso)
    values(
        _tipoObjeto,
        _nombreObjeto,
        _cantidadObjeto,
...
CREATE TABLE IF NOT EXISTS `calendarioact` (
  `IDcalendarioAct` int(11) NOT NULL AUTO_INCREMENT,
  `descripcion` varchar(100) DEFAULT NULL,
  `fechaIngreso` date DEFAULT NULL,
  `fechaRealizacion` date DEFAULT NULL,
  PRIMARY KEY (`IDcalendarioAct`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
-- Volcando datos para la tabla saspre.datosatmosfericosdiarios: ~5 rows (aproximadamente)
