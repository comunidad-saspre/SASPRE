...
REPLACE INTO `cultivos` (`IDcultivo`, `Usuario_Cultivo`, `Cultivo`, `Fecha_Plantado`, `Fecha_Cosecha`, `Cantidad`, `Estado`) VALUES
	...
	(22, 'a', 'Maíz', '2019-03-27', '2019-06-14', 15, 'Probabilidad de Gusano cogollero, Gusano elotero, 30% gallina ciega'),
	(23, 'a', 'Caña', '2019-04-23', '2019-06-14', 1, 'Probabilidad de Gusano Barrenador, Rata, Piojo harinoso de la vid'),
...
-- Volcando datos para la tabla saspre.cultivos_log: ~64 rows (aproximadamente)
...
-- Volcando datos para la tabla saspre.datosatmosfericosdiarios: ~2 rows (aproximadamente)
...
-- Volcando datos para la tabla saspre.datosclimames: ~2,117 rows (aproximadamente)
...
REPLACE INTO `usuario` (`IDUsuario`, `Nombre`, `Apellidos`, `Contra`, `Cargo`, `Nickname`, `Correo`) VALUES
	...
	(8, 'jayson', 'deleon', '2344knkfsf', 'Saspre ABD', 'DiracSpace', 'wjkwj');
...
-- Volcando datos para la tabla saspre.usuario_log: ~0 rows (aproximadamente)
...
REPLACE INTO `usuario_log` (`IDLog`, `Nombre_log`, `Apellidos_log`, `Contra_log`, `Cargo_log`, `Nickname_log`, `Correo_log`, `accion`, `tiempo_log`) VALUES
	(1, 'jayson', 'deleon', '2344knkfsf', 'Saspre ABD', 'DiracSpace', 'wjkwj', 'insert', '2019-06-17 13:25:35');
/*!40000 ALTER TABLE `usuario_log` ENABLE KEYS */;

-- Volcando estructura para disparador saspre.cosechas_before_delete
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `cosechas_before_delete` BEFORE DELETE ON `cosechas` FOR EACH ROW BEGIN 
...
-- Volcando estructura para disparador saspre.cosechas_before_insert
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `cosechas_before_insert` BEFORE INSERT ON `cosechas` FOR EACH ROW BEGIN 
insert into cosechas_log (
		 	   IDCultivo_log, 
            Usuario_Cultivo_log,
            Cultivo_log,
...
-- Volcando estructura para disparador saspre.cosechas_before_update
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `cosechas_before_update` BEFORE UPDATE ON `cosechas` FOR EACH ROW BEGIN 
insert into cosechas_log (
		 	   IDCultivo_log, 
            Usuario_Cultivo_log,
            Cultivo_log,
...
-- Volcando estructura para disparador saspre.cultivos_before_delete
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `cultivos_before_delete` BEFORE DELETE ON `cultivos` FOR EACH ROW BEGIN 
insert into cultivos_log (
			   IDCultivoCosecha_log, 
            Usuario_Cultivo_log,
            Cultivo_log,
            Fecha_Plantado_log,
            Fecha_Cosecha_log,
...
-- Volcando estructura para disparador saspre.cultivos_before_insert
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `cultivos_before_insert` BEFORE INSERT ON `cultivos` FOR EACH ROW BEGIN 
insert into cultivos_log (
			   IDCultivoCosecha_log, 
            Usuario_Cultivo_log,
            Cultivo_log,
...
-- Volcando estructura para disparador saspre.cultivos_before_update
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `cultivos_before_update` BEFORE UPDATE ON `cultivos` FOR EACH ROW BEGIN 
insert into cultivos_log (
			   IDCultivoCosecha_log, 
            Usuario_Cultivo_log,
            Cultivo_log,
...
-- Volcando estructura para disparador saspre.datosclimames_before_delete
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `datosclimames_before_delete` BEFORE DELETE ON `datosclimames` FOR EACH ROW BEGIN
		insert INTO datosclimames_log (
			   Estacion_log,
			   Fecha_Local_log,
			   Fecha_UTC_log,
        ...
        values (
		   	...
		   	old.Fecha_Local,
		   	old.Fecha_UTC,
		   	old.Direccion_del_Viento,
		   	old.Direccion_de_Rafaga,
		   	old.Rapidez_de_Viento,
		   	old.Rapidez_de_Rafaga,
		   	old.Temperatura,
			   old.Humedad_Relativa,
			   old.Presion_Atmosferica,
		   	old.Precipitacion,
			   old.Radiacion_Solar,
            'delete',
            now()
...
-- Volcando estructura para disparador saspre.datosclimames_before_insert
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `datosclimames_before_insert` BEFORE INSERT ON `datosclimames` FOR EACH ROW BEGIN
		insert INTO datosclimames_log (
			   Estacion_log,
			   Fecha_Local_log,
			   Fecha_UTC_log,
...
-- Volcando estructura para disparador saspre.datosclimames_before_update
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `datosclimames_before_update` BEFORE UPDATE ON `datosclimames` FOR EACH ROW BEGIN
		insert INTO datosclimames_log (
			   Estacion_log,
			   Fecha_Local_log,
			   Fecha_UTC_log,
...
-- Volcando estructura para disparador saspre.usuario_before_delete
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
-- Volcando estructura para disparador saspre.usuario_before_insert
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
-- Volcando estructura para disparador saspre.usuario_before_update
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
