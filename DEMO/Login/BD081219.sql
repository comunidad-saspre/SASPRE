...
VALUES(_cultivo, _necesitaNPK, tieneNPK, _diaCalculado)//
DELIMITER ;
...
-- Volcando datos para la tabla saspre.datosatmosfericosdiarios: ~16 rows (aproximadamente)
...
-- Volcando datos para la tabla saspre.datosclimames: ~4,214 rows (aproximadamente)
...
-- Volcando datos para la tabla saspre.fertilizaciones: ~0 rows (aproximadamente)
...
REPLACE INTO `fertilizaciones` (`idFertilizacion`, `cultivo`, `necesitaNPK`, `tieneNPK`, `diaCalculado`) VALUES
	(1, 'Maíz', '150,50,356', NULL, '2019-12-07');
...
-- Volcando datos para la tabla saspre.graficos: ~2 rows (aproximadamente)
